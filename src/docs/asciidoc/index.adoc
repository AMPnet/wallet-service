...
==== Confirm
Used to confirm both project and user deposits.

.Request
include::{snippets}/DepositControllerTest/mustBeAbleToConfirmDeposit/http-request.adoc[]
.Response
include::{snippets}/DepositControllerTest/mustBeAbleToConfirmDeposit/http-response.adoc[]
