...
.Request
include::{snippets}/CooperativeDepositControllerTest/mustBeAbleToSearchProjectByReference/http-request.adoc[]
.Response
include::{snippets}/CooperativeDepositControllerTest/mustBeAbleToSearchProjectByReference/http-response.adoc[]
...
===== Unapproved
Unapproved deposits are all deposits that are not minted - `txHash=null`.
