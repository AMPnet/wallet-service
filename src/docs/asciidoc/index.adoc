...
====== Users
.Request
include::{snippets}/CooperativeDepositControllerTest/mustBeAbleToGetUnsignedDeposits/http-request.adoc[]
.Response
include::{snippets}/CooperativeDepositControllerTest/mustBeAbleToGetUnsignedDeposits/http-response.adoc[]

====== Projects
.Request
include::{snippets}/CooperativeDepositControllerTest/mustBeAbleToGetUnsignedProjectDeposits/http-request.adoc[]
.Response
include::{snippets}/CooperativeDepositControllerTest/mustBeAbleToGetUnsignedProjectDeposits/http-response.adoc[]
