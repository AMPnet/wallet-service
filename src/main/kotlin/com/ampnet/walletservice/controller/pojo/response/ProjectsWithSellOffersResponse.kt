...
data class ProjectsWithSellOffersResponse(val projects: List<ProjectWithSellOffersResponse>)

data class ProjectWithSellOffersResponse(val project: ProjectControllerResponse, val sellOffers: List<SellOfferData>) {
